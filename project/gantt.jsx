// Gantt — Micro Restaurant V2 build schedule, WBS-driven, fully editable
const { useState, useMemo, useRef, useEffect, useCallback, useLayoutEffect } = React;

// ---------- timeline ----------
const PROJECT_START = new Date(2026, 3, 6); // Apr 6 2026 (Mon)
const PROJECT_END = new Date(2026, 6, 19); // Jul 19 2026 (Sun)
...
// ---------- INITIAL WBS ----------
// Each item has stable id + level. Codes are DERIVED from list order.
// Deps reference ids, not codes.
const INITIAL_WBS = [
{ id: "i1", level: 1, name: "Layout Drawing", owner: "KE", start: d(4, 6), end: d(4, 17), pct: 100 },
{ id: "i2", level: 1, name: "BOM", owner: "LI", start: d(4, 13), end: d(4, 24), pct: 100 },

{ id: "i3", level: 1, name: "Cooking Module" },
{ id: "i3_1", level: 2, name: "Module concept", owner: "KE", start: d(4, 20), end: d(5, 1), pct: 100 },
{ id: "i3_2", level: 2, name: "I.H Unit" },
{ id: "i3_2_1", level: 3, name: "H/W 개발", owner: "CH", start: d(5, 4), end: d(6, 5), pct: 75, deps: ["i3_2_2"] },
{ id: "i3_2_2", level: 3, name: "Unit Concept", owner: "KE", start: d(4, 27), end: d(5, 8), pct: 100 },
{ id: "i3_2_3", level: 3, name: "3D 모델링", owner: "RI", start: d(5, 4), end: d(5, 22), pct: 100, deps: ["i3_2_2"] },
{ id: "i3_2_4", level: 3, name: "부품도 작성", owner: "RI", start: d(5, 18), end: d(5, 29), pct: 70, deps: ["i3_2_3"] },
{ id: "i3_2_5", level: 3, name: "발주 및 입고", owner: "LI", start: d(5, 25), end: d(6, 12), pct: 15, deps: ["i3_2_4"] },
{ id: "i3_2_6", level: 3, name: "유닛 개별 테스트 및 보완", owner: "AA", start: d(6, 8), end: d(6, 26), pct: 0, deps: ["i3_2_5"] },
{ id: "i3_3", level: 2, name: "Cooking Frame" },
{ id: "i3_3_1", level: 3, name: "3D 모델링", owner: "RI", start: d(5, 4), end: d(5, 22), pct: 100 },
{ id: "i3_3_2", level: 3, name: "부품도 작성", owner: "RI", start: d(5, 18), end: d(6, 1), pct: 60, deps: ["i3_3_1"] },
{ id: "i3_3_3", level: 3, name: "발주 및 입고", owner: "LI", start: d(5, 25), end: d(6, 12), pct: 15, deps: ["i3_3_2"] },
{ id: "i3_4", level: 2, name: "모듈 조립 및 배선 작업", owner: "IL", start: d(6, 19), end: d(7, 3), pct: 0, deps: ["i3_2_6", "i3_3_3"] },
{ id: "i3_5", level: 2, name: "모듈 테스트 및 보완", owner: "JA", start: d(6, 26), end: d(7, 10), pct: 0, deps: ["i3_4"] },

{ id: "i4", level: 1, name: "Rice Module" },
{ id: "i4_1", level: 2, name: "Module concept", owner: "SE", start: d(4, 27), end: d(5, 8), pct: 100 },
{ id: "i4_2", level: 2, name: "M.W Unit" },
{ id: "i4_2_1", level: 3, name: "H/W 개발", owner: "CH", start: d(5, 4), end: d(6, 5), pct: 70, deps: ["i4_2_2"] },
{ id: "i4_2_2", level: 3, name: "Unit Concept", owner: "SE", start: d(4, 27), end: d(5, 8), pct: 100 },
{ id: "i4_2_3", level: 3, name: "3D 모델링", owner: "RI", start: d(5, 4), end: d(5, 29), pct: 90, deps: ["i4_2_2"] },
{ id: "i4_2_4", level: 3, name: "부품도 작성", owner: "RI", start: d(5, 20), end: d(6, 5), pct: 55, deps: ["i4_2_3"] },
{ id: "i4_2_5", level: 3, name: "발주 및 입고", owner: "72", start: d(6, 1), end: d(6, 19), pct: 0, deps: ["i4_2_4"] },
{ id: "i4_2_6", level: 3, name: "유닛 개별 테스트 및 보완", owner: "JH", start: d(6, 15), end: d(7, 3), pct: 0, deps: ["i4_2_5"] },
{ id: "i4_3", level: 2, name: "Storage Unit" },
{ id: "i4_3_1", level: 3, name: "3D 모델링", owner: "RI", start: d(5, 11), end: d(5, 29), pct: 85 },
{ id: "i4_3_2", level: 3, name: "부품도 작성", owner: "RI", start: d(5, 22), end: d(6, 5), pct: 40, deps: ["i4_3_1"] },
{ id: "i4_3_3", level: 3, name: "발주 및 입고", owner: "72", start: d(6, 1), end: d(6, 19), pct: 0, deps: ["i4_3_2"] },
{ id: "i4_3_4", level: 3, name: "유닛 개별 테스트 및 보완", owner: "LU", start: d(6, 15), end: d(7, 3), pct: 0, deps: ["i4_3_3"] },
{ id: "i4_4", level: 2, name: "Rice Pick_Place Unit" },
{ id: "i4_4_1", level: 3, name: "3D 모델링", owner: "RI", start: d(5, 11), end: d(6, 1), pct: 75 },
{ id: "i4_4_2", level: 3, name: "부품도 작성", owner: "RI", start: d(5, 25), end: d(6, 12), pct: 15, deps: ["i4_4_1"] },
{ id: "i4_4_3", level: 3, name: "발주 및 입고", owner: "LI", start: d(6, 8), end: d(6, 22), pct: 0, deps: ["i4_4_2"] },
{ id: "i4_4_4", level: 3, name: "유닛 개별 테스트 및 보완", owner: "AA", start: d(6, 19), end: d(7, 6), pct: 0, deps: ["i4_4_3"] },
{ id: "i4_5", level: 2, name: "모듈 조립 및 배선 작업", owner: "IL", start: d(6, 26), end: d(7, 10), pct: 0, deps: ["i4_2_6", "i4_3_4", "i4_4_4"] },
{ id: "i4_6", level: 2, name: "모듈 테스트 및 보완", owner: "NO", start: d(7, 6), end: d(7, 17), pct: 0, deps: ["i4_5"] },

{ id: "i5", level: 1, name: "Fridge Module" },
{ id: "i5_1", level: 2, name: "Module concept", owner: "KE", start: d(5, 4), end: d(5, 15), pct: 100 },
{ id: "i5_2", level: 2, name: "Fridge Frame" },
{ id: "i5_2_1", level: 3, name: "3D 모델링", owner: "RI", start: d(5, 11), end: d(5, 29), pct: 80 },
{ id: "i5_2_2", level: 3, name: "부품도 작성", owner: "RI", start: d(5, 22), end: d(6, 5), pct: 35, deps: ["i5_2_1"] },
{ id: "i5_2_3", level: 3, name: "발주 및 입고", owner: "LI", start: d(6, 1), end: d(6, 19), pct: 0, deps: ["i5_2_2"] },
{ id: "i5_3", level: 2, name: "Pouch Cartridge" },
{ id: "i5_3_1", level: 3, name: "3D 모델링", owner: "RI", start: d(5, 18), end: d(6, 5), pct: 50 },
{ id: "i5_3_2", level: 3, name: "부품도 작성", owner: "RI", start: d(5, 29), end: d(6, 12), pct: 15, deps: ["i5_3_1"] },
{ id: "i5_3_3", level: 3, name: "발주 및 입고", owner: "72", start: d(6, 8), end: d(6, 22), pct: 0, deps: ["i5_3_2"] },
{ id: "i5_3_4", level: 3, name: "유닛 개별 테스트 및 보완", owner: "JH", start: d(6, 19), end: d(7, 3), pct: 0, deps: ["i5_3_3"] },
{ id: "i5_4", level: 2, name: "Pouch Cartridge (확장)", owner: "LU", start: d(6, 8), end: d(7, 3), pct: 0 }];
...
// ====================================================================
const STORAGE_KEY = "mr-v2-gantt-state-v1";
  ...
  return (
    <header style={{ marginBottom: 24 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", borderBottom: "1px solid var(--ink)", paddingBottom: 14 }}>
        ...
        <span className="mono small-caps" style={{ color: "var(--ink-3)" }}>Build Schedule · Hardware Ops</span>
      </div>

      <div style={{ display: "grid", gridTemplateColumns: "1fr auto", alignItems: "end", marginTop: 16, gap: 24 }}>
        <div>
          <div className="mono small-caps" style={{ color: "var(--accent)", marginBottom: 6 }}>Micro Restaurant V2 · MVP build</div>
          <h1 className="serif" style={{ fontSize: 56, lineHeight: 1.0, margin: 0, letterSpacing: "-0.02em", color: "var(--ink)" }}>
            Cooking · Rice · Fridge <span style={{ fontStyle: "italic", color: "var(--accent)" }}>—</span> WBS schedule
          </h1>
        </div>
    ...
    <footer style={{ marginTop: 32, display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 28, paddingTop: 18, borderTop: "1px solid var(--line)" }}>
      ...
      <div>
        ...
        <ul style={{ margin: 0, padding: 0, listStyle: "none", fontSize: 12.5, color: "var(--ink-2)" }}>
          <li style={{ display: "flex", justifyContent: "space-between", padding: "4px 0", borderBottom: "1px dashed var(--line-2)" }}>
            <span>BOM lock</span><span className="mono" style={{ color: "var(--accent)" }}>Apr 24</span>
          </li>
          <li style={{ display: "flex", justifyContent: "space-between", padding: "4px 0", borderBottom: "1px dashed var(--line-2)" }}>
            <span>I.H Unit 부품도 완료</span><span className="mono">May 29</span>
          </li>
          <li style={{ display: "flex", justifyContent: "space-between", padding: "4px 0", borderBottom: "1px dashed var(--line-2)" }}>
            <span>모든 유닛 입고 완료</span><span className="mono">Jun 22</span>
          </li>
          <li style={{ display: "flex", justifyContent: "space-between", padding: "4px 0", borderBottom: "1px dashed var(--line-2)" }}>
            <span>Cooking 모듈 조립 시작</span><span className="mono" style={{ color: "var(--accent)" }}>Jun 19</span>
          </li>
          <li style={{ display: "flex", justifyContent: "space-between", padding: "4px 0" }}>
            <span>모듈 테스트 완료</span><span className="mono" style={{ color: "var(--accent)" }}>Jul 17</span>
          </li>
        </ul>
      </div>
    </footer>);
